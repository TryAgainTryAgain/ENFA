...
BeldingsStack <- stack (elevation, slope, tri, ndvicv, ndvimeanmax, ppt0609, ppt1005, tmin01, tmax07, snow, aspen, conifer, meadow, mixed, rock, shrub)

nlayers(BeldingsStack)
...
var.names.x <- names(BeldingsStack)
