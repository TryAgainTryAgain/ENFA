...
#Save cropped or resampled files so that I don't have to resample each time I run this. 
#writeRaster(elevation, "SNV/ResampledRasterFiles/elevation30x30")
#writeRaster(slope, "SNV/ResampledRasterFiles/slope30x30")
#writeRaster(tri, "SNV/ResampledRasterFiles/tri30x30")
#writeRaster(snow, "SNV/ResampledRasterFiles/snow30x30")
...
#writeRaster(mixed, "SNV/ResampledRasterFiles/snow30x30")
